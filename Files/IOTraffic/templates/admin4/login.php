...
<div class="content">
	...
	<form class="login-form" action="index.php" method="post">
		...
		<div class="create-account">
			<p>
				<a href="javascript:;" id="register-btn">יצירת משתמש</a>
			</p>
		</div>
	</form>
	<!-- END LOGIN FORM -->
	...
	<form class="forget-form" action="index.html" method="post">
		...
		<div class="form-actions">
			<button type="button" id="back-btn" class="btn btn-default">חזור</button>
			<button type="submit" class="btn btn-primary uppercase pull-right">אישור</button>
		</div>
	</form>
	...
	<form class="register-form" action="index.html" method="post">
		...
		<div class="form-group">
			<!--ie8, ie9 does not support html5 placeholder, so we just show field title for that-->
			<label class="control-label visible-ie8 visible-ie9">כתובת מייל</label>
			<input class="form-control placeholder-no-fix" type="text" placeholder="Email" name="email"/>
		</div>
		<div class="form-group">
			<label class="control-label visible-ie8 visible-ie9">כתובת מגורים</label>
		...
		<div class="form-actions">
			<button type="button" id="register-back-btn" class="btn btn-default">חזרה</button>
			<button type="submit" id="register-submit-btn" class="btn btn-primary uppercase pull-right">אישור</button>
		</div>
	</form>
