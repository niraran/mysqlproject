...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<?php
			$tl_id = $_POST["tl_id"]; //Traffic Light ID
			...
			mysql_query("INSERT INTO traffic_light (id_trafficLight, id_crossRoad, id_location, inCrossroad, trafficLight_Direction, trafficLight_Admin, u_turn, trafficLight_Pedestrians, trafficLight_Status) VALUES ('$tl_id', '$crossroad', '$location', '$in_crossroad', '$direction', '$admin', '$u_turn', '$pedestrians', 'RED')",$connection);
			?>
				...
				<div class="col-md-12">
								<div class="portlet box blue-hoki">
									<div class="portlet-title">
										<div class="caption">
											<i class="icon-plus"></i>הוספת רמזור חדש
										</div>
										<div class="tools">
