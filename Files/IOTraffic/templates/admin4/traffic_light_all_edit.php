	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<li>
					<a href="traffic_light_all_edit.php">כל הרמזורים - עריכה</a>
				</li>
			</ul>
			<!-- END PAGE BREADCRUMB -->
			<!-- END PAGE HEADER-->
							...
							<tr>
								...
								<tbody>
									...
									$lng = mysql_result(mysql_query("SELECT lng from location where id_location=$location_id",$connection),0) ;
										...
										echo 		'<a href="traffic_light_edit.php?TL='.mysql_result($result2,$i,"id_trafficLight").'"><button class="btn btn-sm green"><i class="icon-pencil"></i> עריכה</button></a>' ;
										echo	'</td>' ;
										echo '</tr>' ;
										$i++;	
									}
