...
<div class="page-container">
	<!-- BEGIN SIDEBAR -->
	<?php $Primary = 4; $Secondary = 4.2; include 'views\Menu.php'; ?>
	<!-- END SIDEBAR -->
	<!-- BEGIN CONTENT -->
				...
				<div class="col-md-12">
					...
					<div class="portlet box blue-hoki">
						<div class="portlet-title">
							<div class="caption">
								<i class="icon-plus"></i>הוספת מצלמה חדשה
							</div>
							<div class="tools">
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form action="camera_add2.php" id="form_sample_2" class="form-horizontal" method="post">
								<div class="form-body">
									...
									<div class="form-group">
										<label class="control-label col-md-3">מספר מצלמה <span class="required">
										* </span>
										</label>
										<div class="col-md-4">
											<div class="input-icon right">
												...
												<td><div id='camera_id1'></div></td>
											</div>
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-md-3">שם רחוב / כתובת רחוב <span class="required">
										* </span>
										</label>
										<div class="col-md-4">
											<div class="input-icon right">
												<i class="fa"></i>
												<input type="text" class="form-control" name="camera_location_name"/>
												<td><div id='camera_location_name1'></div></td>
											</div>
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-md-3">כתובת URL <span class="required">
										* </span>
										</label>
										<div class="col-md-4">
											<div class="input-icon right">
												...
												<td><div id='camera_url1'></div></td>
											</div>
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-md-3">כתובת IP

										</label>
										<div class="col-md-4">
											<div class="input-icon right">
												<i class="fa"></i>
												<input type="text" class="form-control" name="camera_ip"/>
												<td><div id='camera_ip1'></div></td>
											</div>
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-md-3">כיוון צפיה <span class="required">
										* </span>
										</label>
										<div class="col-md-4">
											<select class="form-control" name="camera_direction">
												<option></option>
												<?php
													$enumList = get_enum_values('camera', 'camera_Direction') ;
													$i=0;
										...
										* </span>
										...
										<div class="col-md-4">
											<select class="form-control" name="admin">
												<option></option>
												<?php
													$enumList = get_enum_values('camera', 'camera_Admin') ;
													$i=0;
													while ($i < count($enumList))
													{
														echo '<option>'.$enumList[$i].'</option>' ;
									...
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-4">
											<div class="input-icon right">
												<i class="fa"></i>
												<input type="text" class="form-control" name="camera_location"/>
											</div>
										</div>
									</div>
								</div>
								<div class="form-actions">
									<div class="row">
										<div class="col-md-offset-3 col-md-9">
											<button type="submit" class="btn green">הוספת מצלמה</button>
