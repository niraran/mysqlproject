...
<link href="../../assets/admin/pages/css/lock2-rtl.css" rel="stylesheet" type="text/css"/>
...
<div class="page-lock">
	<div class="page-logo">
		...
		<img src="../../assets/admin/layout4/img/IOTrafficLOGOWhite.png" alt="logo"/>
		</a>
	</div>
	<div class="page-body">
		...
		<div class="page-lock-info">
			<h1>דולב שור</h1>
			<span class="email">
			dolevshor@gmail.com </span>
			<span class="locked">
			נעול </span>
			<form class="form-inline" action="index.html">
				<div class="input-group input-medium">
					<input type="text" class="form-control" placeholder="סיסמא">
