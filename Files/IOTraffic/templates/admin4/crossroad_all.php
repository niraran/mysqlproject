...
<div class="page-container">
	<!-- BEGIN SIDEBAR -->
	<?php $Primary = 3; $Secondary = 3.1; include 'views\Menu.php'; ?>
	<!-- END SIDEBAR -->
	<!-- BEGIN CONTENT -->
				...
				<div class="col-md-12">
					...
					<div class="portlet box blue-hoki">
						<div class="portlet-title">
							<div class="caption">
								<i class="icon-target"></i>כלל הצמתים
							</div>
							<div class="tools">
							</div>
						</div>
							...
							<tr>
								...
								<tbody>
									...
									while ($i < $num3)
									{
										...
										echo '<tr>' ;
										echo	'<td>' ;
										echo 		'<a href="crossroad_single.php?CR='.mysql_result($result3,$i,"id_CrossRoad").'">' ;
										echo			$line ;
										echo 		'</a>' ;
										++$line ;
										echo	'</td>' ;
										echo	'<td>' ;
										echo 		'<a href="crossroad_single.php?CR='.mysql_result($result3,$i,"id_CrossRoad").'">' ;
										echo	mysql_result($result3,$i,"id_CrossRoad") ;
										echo 		'</a>' ;
										echo	'</td>' ;
										echo	'<td>' ;
										echo 		'<a href="crossroad_single.php?CR='.mysql_result($result3,$i,"id_CrossRoad").'">' ;
										echo	mysql_result($result3,$i,"crossroadName") ;
										echo 		'</a>' ;
										echo	'</td>' ;
										echo	'<td>' ;
										$crossID = mysql_result($result3,$i,"id_CrossRoad");
										$query5="SELECT * FROM traffic_light where id_crossRoad=$crossID";
										$result5=mysql_query($query5);
										$num5=mysql_numrows($result5);
										echo	$num5;
										echo	'</td>' ;
										echo	'<td>' ;
										$query6="SELECT * FROM camera where id_crossRoad=$crossID";
										$result6=mysql_query($query6);
										$num6=mysql_numrows($result6);
										echo	$num6;
										echo	'</td>' ;										
										echo	'<td>' ;
										echo	mysql_result($result3,$i,"numOfWays") ;
										echo	'</td>' ;										
										echo	'<td>' ;
