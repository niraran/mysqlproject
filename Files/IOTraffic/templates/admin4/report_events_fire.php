...
<div class="page-container">
	<!-- BEGIN SIDEBAR -->
	<?php $Primary = 5; $Secondary = 5.5; include 'views\Menu.php'; ?>
	<!-- END SIDEBAR -->
	<!-- BEGIN CONTENT -->
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<li>
					<a href="report_events_fire.php">דו"ח ארועי כיבוי אש</a>
				</li>
			</ul>
			<!-- END PAGE BREADCRUMB -->
			<!-- END PAGE HEADER-->
							...
							<tr>
								...
								<tbody>
									...
									while ($i < $num)
									{
										...
										if (mysql_result($result,$i,"eventCategory") == 'FIRE')
										{
