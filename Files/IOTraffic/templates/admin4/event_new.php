				...
				<div class="col-md-12">
					...
					<div class="portlet box blue-hoki">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-bullhorn"></i>יצירת אירוע חדש
							</div>
							<div class="tools">
							...
							<form action="#" id="form_sample_2" class="form-horizontal">
								<div class="form-body">
									...
									<div class="form-group">
										<label class="control-label col-md-3">שם הארוע <span class="required">
										* </span>
										</label>
										<div class="col-md-4">
									...
									<div class="form-group">
										<label class="control-label col-md-3">תיאור האירוע <span class="required">
										* </span>
										</label>
										<div class="col-md-4">
											<div class="input-icon right">
									...
									<div class="form-group">
										<label class="control-label col-md-3">יוזם הארוע <span class="required">
										* </span>
										</label>
										<div class="col-md-4">
											<select class="form-control">
												<option>משטרה</option>
												<option>מכבי אש</option>
												<option>מגן דוד אדום</option>
												<option>עירייה</option>
											</select>
										</div>	
									</div>
									<div class="form-group">
										<label class="control-label col-md-3">קטגוריה <span class="required">
										* </span>
										</label>
										<div class="col-md-4">
											<select class="form-control">
												<option>תאונה</option>
												<option>חסימת כביש</option>
												<option>פינוי פצועים</option>
												<option>אחר</option>
											</select>
										</div>	
									</div>	
								...
								<div class="form-actions">
									<div class="row">
										<div class="col-md-offset-3 col-md-9">
											<button type="submit" class="btn green">הוספת אירוע</button>
