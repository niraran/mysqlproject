...
<div class="page-container">
	<!-- BEGIN SIDEBAR -->
	<?php $Primary = 5; $Secondary = 5.2; include 'views\Menu.php'; ?>
	<!-- END SIDEBAR -->
	<!-- BEGIN CONTENT -->
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<li>
					<a href="report_events_all.php">דו"ח כלל הארועים</a>
				</li>
			</ul>
			<!-- END PAGE BREADCRUMB -->
			<!-- END PAGE HEADER-->
							...
							<tr>
								...
								<tbody>
									...
									//$eventCategory = mysql_result($result,$i,"eventCategory");
										...
										$myvalueEnd = mysql_result($result,$i,"EndTime") ;
