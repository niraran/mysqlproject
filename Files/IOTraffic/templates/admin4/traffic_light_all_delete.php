...
<div class="page-container">
	<!-- BEGIN SIDEBAR -->
	<?php $Primary = 2; $Secondary = 2.4; include 'views\Menu.php'; ?>
	<!-- END SIDEBAR -->
	<!-- BEGIN CONTENT -->
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<li>
					<a href="traffic_light_all_delete.php">כל הרמזורים - מחיקה</a>
				</li>
			</ul>
			<!-- END PAGE BREADCRUMB -->
			<!-- END PAGE HEADER-->
							...
							<tr>
								...
								<tbody>
									...
									$lng = mysql_result(mysql_query("SELECT lng from location where id_location=$location_id",$connection),0) ;
										...
										echo 		'<a href="query/DEL_TL.php?param1='.mysql_result($result2,$i,"id_trafficLight").'&amp;param2=delete"><button class="btn btn-sm red"><i class="fa fa-trash-o"></i> מחיקה</button></a>' ;
										echo	'</td>' ;
										echo '</tr>' ;
										$i++;	
									}
