...
<div class="page-container">
	<!-- BEGIN SIDEBAR -->
	<?php $Primary = 5; $Secondary = 5.6; include 'views\Menu.php'; ?>
	<!-- END SIDEBAR -->
	<!-- BEGIN CONTENT -->
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<li>
					<a href="reports_all.php">דוחות</a>
					<i class="fa fa-circle"></i>
				</li>
				<li>
					<a href="report_events_municipality.php">דו"ח ארועי עירייה</a>
				</li>
			</ul>
			<!-- END PAGE BREADCRUMB -->
			<!-- END PAGE HEADER-->
							...
							<tr>
								...
								<tbody>
									...
									while ($i < $num)
									{
										...
										if (mysql_result($result,$i,"eventCategory") == 'MUNICIPALITY')
										{
										...
										if (mysql_result($result,$i,"eventStatus") == 'open')
										{
											...
											echo 		'<a href="event_single.php?EVT='.mysql_result($result,$i,"id_event").'">' ;
											echo			'<span class="label label-sm label-success"> פעיל </span>' ;
											echo 		'</a>' ;
											echo		'</td>' ;
										}
										elseif (mysql_result($result,$i,"eventStatus") == 'pending')
										{
											echo		'<td align="center">' ;
											echo 		'<a href="event_single.php?EVT='.mysql_result($result,$i,"id_event").'">' ;
											echo			'<span class="label label-sm label-warning"> ממתין לאישור </span>' ;
											echo 		'</a>' ;
											echo		'</td>' ;
										}
										if (mysql_result($result,$i,"eventStatus") == 'close')
										{
											echo		'<td align="center">' ;
											echo 		'<a href="event_single.php?EVT='.mysql_result($result,$i,"id_event").'">' ;
											echo			'<span class="label label-sm label-danger"> סגור </span>' ;
											echo 		'</a>' ;
											echo		'</td>' ;
										}															
