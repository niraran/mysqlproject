...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			mysql_query("INSERT INTO camera (id_camera, camera_LocationName, camera_URL, camera_IP, camera_Direction, camera_Admin, id_CrossRoad, inCrossRoad, id_location) VALUES ('$c_id', '$c_name', '$c_url', '$c_ip', '$direction', '$admin', '$crossroad', '$in_crossroad', '$location')",$connection);
			?>
				...
				<div class="col-md-12">
								<div class="portlet box blue-hoki">
									<div class="portlet-title">
										<div class="caption">
											<i class="icon-plus"></i>הוספת מצלמה
										</div>
										<div class="tools">
